...

{
  'variables': {
    'v8_inspector_files': [
      '<(SHARED_INTERMEDIATE_DIR)/blink/platform/v8_inspector/protocol/Debugger.cpp',
      '<(SHARED_INTERMEDIATE_DIR)/blink/platform/v8_inspector/protocol/Debugger.h',
      '<(SHARED_INTERMEDIATE_DIR)/blink/platform/v8_inspector/protocol/HeapProfiler.cpp',
      '<(SHARED_INTERMEDIATE_DIR)/blink/platform/v8_inspector/protocol/HeapProfiler.h',
      '<(SHARED_INTERMEDIATE_DIR)/blink/platform/v8_inspector/protocol/Profiler.cpp',
      '<(SHARED_INTERMEDIATE_DIR)/blink/platform/v8_inspector/protocol/Profiler.h',
      '<(SHARED_INTERMEDIATE_DIR)/blink/platform/v8_inspector/protocol/Runtime.cpp',
      '<(SHARED_INTERMEDIATE_DIR)/blink/platform/v8_inspector/protocol/Runtime.h',
      ...
      'platform/inspector_protocol/DispatcherBase.cpp',
      'platform/inspector_protocol/DispatcherBase.h',
